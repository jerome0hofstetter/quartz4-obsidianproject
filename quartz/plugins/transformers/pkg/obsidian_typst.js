...
export class Compiler {
    ...
    constructor(root, request_data) {
        ...
        const ret = wasm.compiler_new(ptr0, len0, request_data);
     ...
     * @returns {ImageData}
     */
    compile_image(text, path, pixel_per_pt, size, display) {
        const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(path, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.compiler_compile_image(this.__wbg_ptr, ptr0, len0, ptr1, len1, pixel_per_pt, size, display);
        if (ret[2]) {
    ...
    add_font(data) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.compiler_add_font(this.__wbg_ptr, ptr0, len0);
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('obsidian_typst_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
